...
//品名pinming，规格guige，材质caizhi，产地chandi，数量shuliang，种类zhonglei，交割仓库cangku
//============================================================================================================
func (t *SimpleChaincode) CreateDigitalAssets (stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	digitalAsset.Zhongliang = args[9]
	digitalAsset.Jianshu = args[10]
	digitalAsset.Cangku = args[11]
